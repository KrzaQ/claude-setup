...
claude/files/     — verbatim files copied to the ~/.claude root (e.g. statusline-command.sh)
...
```bash
make save      # copy Claude agents, skills, files, and managed settings from ~/.claude into this repo
make install   # apply Claude agents, skills, files, and managed settings from this repo into ~/.claude
...
## Adding a new Claude agent, skill, file, or managed settings key
